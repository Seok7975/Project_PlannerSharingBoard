...
<body>
    <%
        ...
        if (user == null) {
            out.println("<script>alert('사용자 정보를 불러오는데 실패했습니다.'); location.href='main.jsp';</script>");
            return;
        }
    ...
    <div class="container">
        ...
        %>
        <form action="profileAction.jsp" method="post" onsubmit="return validateForm();">
