...
<%
    ...
    if (user == null) {
        ...
        script.println("alert('사용자 정보를 불러오는데 실패했습니다.');");
    ...
    //디버깅용
    /* System.out.println(newPassword + " " + confirmPassword + " " + user.getUserPassword()); */
    ...
    if (!newPassword.equals(confirmPassword)) {
        ...
        script.println("</script>");
    } else if (user.getUserPassword() != null && newPassword.equals(user.getUserPassword())) {
        PrintWriter script = response.getWriter();
        script.println("<script>");
